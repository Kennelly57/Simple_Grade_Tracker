 ...
 */
public class SubassignmentOverview extends Application {
    private Stage univPrimaryStage;
    @Override
    public void start(Stage primaryStage){

        univPrimaryStage = primaryStage;
        start(primaryStage, "Owl Colors and Patterns", "Quizes");
    }

    public void start(Stage primaryStage, String courseName, String categoryName) {
        ...
        String title = String.format("Courses --> %s --> %s:", courseName, categoryName);
        ...
        overviewBorderPane.setBottom(btnBack);
        BorderPane.setAlignment(btnFinish, Pos.BOTTOM_RIGHT);
        //---------------------------------------------------------------------------------------
        ...
        private HBox generateSubItemHBox() {
            ...
            buttonsHbox.setAlignment(btnBack, Pos.BOTTOM_LEFT);
            overviewBorderPane.setBottom(buttonsHbox);
            BorderPane.setAlignment(buttonsHbox, Pos.BOTTOM_CENTER);
